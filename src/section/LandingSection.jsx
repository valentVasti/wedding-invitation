...
const LandingSection = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(background.current, { scale: 1.5, opacity: 0 }, { scale: 1, opacity: 1, duration: 1.5 })
    gsap.fromTo('.animate-text', { opacity: 0, y: 20 }, { y: 0, opacity: 1, duration: 2, delay: 2 });
